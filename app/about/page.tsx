      ...
      <div className="py-12">
        ...
        <div className="container d-f max-md:flex-wrap gap-12 max-md:px-4">
          ...
          <div className="md:w-1/2">
            ...
            <h1 className="text-2xl md:text-4xl font-bold mb-12 mt-3">EMAX-B INTERNATIONAL LOGISTICS jamoamiz 2017- yildan buyon xizmat ko’rsatib kelmoqda</h1>
            <h2>&nbsp;&nbsp;&nbsp; EMAX-B INTERNATIONAL LOGISTICS jamoasi 2017- yildan buyona XITOY, ROSSIYA,
